...
// Servidor MQTT
const char* mqttServer = "10.0.110.157";
const int mqttPort = 1884;
const char* mqttUser = "Prueba2";
const char* mqttPassword = "Prueba2";
...
void loop() {
  ...
  if (movimiento == HIGH) {
    client.publish("Sensor", "Movimiento detectado"); // Reemplazar "tu_topic" por tu topico
  } else {
    client.publish("Sensor", "Sin movimiento"); // Reemplazar "tu_topic" por tu topico
  }
